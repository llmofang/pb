...
class FutureData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:comm.FutureData) */ {
 public:
  FutureData();
  virtual ~FutureData();
  ...
  static const FutureData* internal_default_instance();

  void Swap(FutureData* other);

  // implements Message ----------------------------------------------

  inline FutureData* New() const { return New(NULL); }

  FutureData* New(::google::protobuf::Arena* arena) const;
  ...
  void InternalSwap(FutureData* other);
  void UnsafeMergeFrom(const FutureData& from);
  private:
  ...
  bool has_preopeninterest() const;
  ...
  ::google::protobuf::uint32 presettleprice() const;
  void set_presettleprice(::google::protobuf::uint32 value);
  ...
  ::google::protobuf::uint32 close() const;
  void set_close(::google::protobuf::uint32 value);
  ...
  ::google::protobuf::uint32 settleprice() const;
  void set_settleprice(::google::protobuf::uint32 value);
  ...
  bool has_currdelta() const;
  void clear_currdelta();
  static const int kCurrDeltaFieldNumber = 22;
  ::google::protobuf::int32 currdelta() const;
  void set_currdelta(::google::protobuf::int32 value);
  ...
  bool has_auctionprice() const;
  void clear_auctionprice();
  static const int kAuctionPriceFieldNumber = 27;
  ::google::protobuf::int32 auctionprice() const;
  void set_auctionprice(::google::protobuf::int32 value);

  // required int32 AuctionQty = 28;
  bool has_auctionqty() const;
  void clear_auctionqty();
  static const int kAuctionQtyFieldNumber = 28;
  ::google::protobuf::int32 auctionqty() const;
  void set_auctionqty(::google::protobuf::int32 value);
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_futureData_2eproto_impl();
  friend void  protobuf_AddDesc_futureData_2eproto_impl();
  friend void protobuf_AssignDesc_futureData_2eproto();
  friend void protobuf_ShutdownFile_futureData_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<FutureData> FutureData_default_instance_;
